      ...
      <div className="flex flex-col h-full ">
        ...
        <div className="flex items-center p-2">
          <form className="flex-1 flex gap-2" onSubmit={handleSubmit}>
            ...
            <Button type="submit" className="bg-gradient-to-r from-turquoise-500 to-red-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold px-6 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
